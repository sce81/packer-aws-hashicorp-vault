...
build {
  ...
  provisioner "shell" {
    inline = [
        ...
        "wget https://releases.hashicorp.com/${var.APPNAME}/${var.VERSION}/${var.APPNAME}_${var.VERSION}_darwin_amd64.zip -O /tmp/${var.APPNAME}.zip",
        "unzip /tmp/${var.APPNAME}*",
        "mv /tmp/${var.APPNAME} /usr/local/bin/"
    ]
  }
}